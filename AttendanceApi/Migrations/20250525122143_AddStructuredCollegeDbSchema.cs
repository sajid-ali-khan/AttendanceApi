...
{
    /// <inheritdoc />
    public partial class AddStructuredCollegeDbSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferedPrograms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfferedPrograms_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfferedPrograms_Schemes_SchemeId",
                        column: x => x.SchemeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OfferedProgramId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentBatches_OfferedPrograms_OfferedProgramId",
                        column: x => x.OfferedProgramId,
                        principalTable: "OfferedPrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_StudentBatches_StudentBatchId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Roll = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedRole = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    FacultyId = table.Column<int>(type: "int", nullable: false),
                    NumPresent = table.Column<int>(type: "int", nullable: false),
                    NumAbsent = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_StudentBatchId_SubjectId",
                table: "Courses",
                columns: new[] { "StudentBatchId", "SubjectId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferedPrograms_BranchId",
                table: "OfferedPrograms",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferedPrograms_SchemeId",
                table: "OfferedPrograms",
                column: "SchemeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentBatches_OfferedProgramId",
                table: "StudentBatches",
                column: "OfferedProgramId");
